...
export const BentoGridItem = ({
    ...
    return (
        ...
        >
            <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 transition duration-200 group-hover/bento:opacity-10" />
            {header}
